...
import (
	...
	"github.com/topdefi/Coin-Shiv/consensus/beacon"
	...
	"github.com/topdefi/Coin-Shiv/core/state/pruner"
	...
	"github.com/topdefi/Coin-Shiv/internal/shutdowncheck"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	log.Info("Initialising Shivay protocol", "network", config.NetworkId, "dbversion", dbVer)
