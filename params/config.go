...
var TrustedCheckpoints = map[common.Hash]*TrustedCheckpoint{
	...
	TestShivGenesisHash:  TestShivTrustedCheckpoint,
}
...
var CheckpointOracles = map[common.Hash]*CheckpointOracleConfig{
	...
	TestShivGenesisHash:  TestShivCheckpointOracle,
}

var (
	// MainnetChainConfig is the chain parameters to run a node on the main network.
	MainnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(1159),
	...
	// TestShivChainConfig is the chain parameters to run a node on the main network.
	TestShivChainConfig = &ChainConfig{
		ChainID:             big.NewInt(1169),
		HomesteadBlock:      big.NewInt(0),
		EIP150Block:         big.NewInt(0),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
	...
	TestShivCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0x51944482997eB509aB8fcad001E3E8B437aC9F74"),
		Signers: []common.Address{
			common.HexToAddress("0x51944482997eB509aB8fcad001E3E8B437aC9F74"),
		},
